...
$userJS = @'
// BearBrowser — 101 JS fingerprinting shield
// Generated by BearBrowser packaging; do not edit manually
...
// ── WebGL ─────────────────────────────────────────────────────────────────────
user_pref("webgl.disabled", false);  // keep enabled but spoofed
